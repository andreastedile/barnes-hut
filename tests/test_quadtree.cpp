...
TEST_CASE("empty tree creation") {
  ...
  REQUIRE(root.m_top_left == Vector2f{0, 10});
  REQUIRE(root.m_length == 10);
...
TEST_CASE("body insertion") {
  Node root({0, 10}, 10);  // Root's quadrant has depth 0
  ...
  REQUIRE(ne2->m_top_left == Vector2f{2.5, 10});
  REQUIRE(ne2->m_length == 2.5);
  ...
  REQUIRE(se2->m_top_left == Vector2f{2.5, 7.5});
  REQUIRE(se2->m_length == 2.5);
  ...
  REQUIRE(sw2->m_top_left == Vector2f{0, 7.5});
  REQUIRE(sw2->m_length == 2.5);

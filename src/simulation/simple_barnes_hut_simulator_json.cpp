...
void to_json(json &j, const SimulationStep &step) {
  ...
  j["bodies"] = bodies;
  // step 0 does not have a quadtree; data is loaded from file
  if (step.m_quadtree) {
